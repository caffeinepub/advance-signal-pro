    ...
    <Card className={`p-6 mb-6 border-2 ${bgColor}`}>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          {!isSemEntrada && isBullish && (
            <TrendingUp className="w-8 h-8 text-chart-1" />
          )}
          {!isSemEntrada && isBearish && (
            <TrendingDown className="w-8 h-8 text-destructive" />
          )}
          {!isSemEntrada && isSideways && (
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              {!isSemEntrada && !isNeutro && isBullish && (
                <ArrowUp className="w-6 h-6 text-chart-1" />
              )}
              {!isSemEntrada && !isNeutro && isBearish && (

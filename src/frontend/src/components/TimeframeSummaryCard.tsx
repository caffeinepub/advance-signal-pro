...
export default function TimeframeSummaryCard({
  entry,
  highlighted = false,
}: TimeframeSummaryCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <span
          className={`px-2 py-0.5 rounded-full text-xs font-bold border ${colors.badge}`}
        >
          {entry.timeframe}
        </span>
        {highlighted && (
